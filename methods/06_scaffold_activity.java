//The file that actually runs this is called "brickwall.java"
...
//System.out.println("The line below should print a row starting with a half brick, then 3 full bricks then a half brick");
    ...
    //System.out.println("The line below should print a wall six bricks wide and 5 rows tall, alternating between the two types of rows");
    //System.out.println(wall(6,5));
    //
