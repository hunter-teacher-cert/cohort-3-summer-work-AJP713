/**
 * ArrayPractice by Team 7
 * Adam Prado
 * collaborators: Sueann Seccafico, Amanda Lee, Christine Marra, Kirk Martin
 */
...
public class ArrayPractice
{
  ...
  */
  public static void flip( int[] data )
  {
    ...
    for(int i=0;i<data.length;i++){  //TODO fix this, it does not work 
      data[i]=newArray[i];           //TODO fix this, it does not work
    }
  ...
  public static void main( String[] args )
  {
    ...
    System.out.println("Max of list data: "+ findMaxValue(data));
    System.out.println("Max of list data2: "+ findMaxValue(data2));
    System.out.println("Count of odd numbers in data 2 is "+  countOdds(data2) );
    flip(data2);
    System.out.println("flipping order of data 2 ");
    printArray(data2);
